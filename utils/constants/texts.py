...
EXEMPTED_WINDOW_TITLES = [
    ...
    "visual studio code",
    "vs code",
    "ChemiNotify - Visual Studio Code",
]  # needed to code this app lol
...
POPUP_ERROR = {"title": [], "text": ["erreur"], "return_value": "erreur"}

POPUP_ABOUT = {"title": ["À propos de ChemiNot"], "text": [], "return_value": "about"}

POPUP_SESSION_SELECTION = {
    "title": ["ChemiNot"],
    "text": [
        "Pour quelle session voulez-vous"
    ],  # Pour quelle session voulez-vous modifier votre choix de cours ?
...
POPUP_ATTENTION = {
    ...
    "text": [
        "est obligatoire si"
    ],  # 'Le cours PEP110 est obligatoire si vous devez suivre TIN503',
